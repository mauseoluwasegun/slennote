  ...
  return (
    <div className="launch-page" data-theme="tan">
      ...
      <nav className={`launch-sidebar ${sidebarOpen ? "mobile-open" : ""}`}>
        <div className="launch-sidebar-title">slent</div>
      ...
      <div className="launch-container">
        <section id="intro">
          <h1 className="launch-title">About slent</h1>
        ...
        <section id="key-features" className="launch-section">
          ...
          <ul className="feature-list">
            ...
            <li>Focus Mode with ambient sounds for studying</li>
          </ul>
        </section>
        ...
        <section id="realtime" className="launch-section">
          ...
          <p>
            Built on Convex, slent provides real-time synchronization
