# SlentNote - The open-source modern todo app for developers and busy people with convex and no ai assistants

An open source, real-time open-source to-do list that never falls out of sync — built on Convex.

**Live Demo**: [slent.co](https://slent.co)
...
- **Focus Mode** - distraction-free study mode with ambient sounds, study timer, and productivity tips
